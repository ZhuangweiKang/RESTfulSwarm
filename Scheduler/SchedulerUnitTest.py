...
class TestScheduler(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.logger = utl.doLog('SchedulerUnitTestLogger', 'SchedulerUnitTestLog')
    ...
    def test_bf(self):
        ...
        scheduler = BestFitScheduler(self.db, self.workersInfo, self.workersResourceInfo)
    ...
    def test_bfd(self):
        ...
        scheduler = BestFitDecreasingScheduler(self.db, self.workersInfo, self.workersResourceInfo)
        self.bin_packing(expect=expect, strategy=scheduler.best_fit, request=request, available=available)
    ...
    def test_ff(self):
        ...
        available = []
        expect = [(0, -1), (1, -1), (2, -1), (3, -1), (4, -1), (5, -1), (6, -1)]
        scheduler = FirstFitScheduler(self.db, self.workersInfo, self.workersResourceInfo)
    ...
    def test_ffd(self):
        ...
        scheduler = FirstFitDecreasingScheduler(self.db, self.workersInfo, self.workersResourceInfo)
        self.bin_packing(expect=expect, strategy=scheduler.first_fit, request=request, available=available)
